package com.fnconn.chartlibrary.manager;

import android.content.Context;
import android.graphics.drawable.Drawable;
import android.view.MotionEvent;

import com.fnconn.chartlibrary.R;
import com.fnconn.chartlibrary.bean.CompositeIndexBean;
import com.fnconn.chartlibrary.bean.IncomeBean;
import com.fnconn.chartlibrary.utils.DateUtil;
import com.fnconn.chartlibrary.view.LineChartMarkView;
...
//        rightYAxis.setAxisMinimum(0f);
        ...
        leftYAxis.setZeroLineColor(R.color.black);
        leftYAxis.setZeroLineWidth(1f);
        leftYAxis.setAxisLineWidth(1f);

        rightYAxis.setLabelCount(5);
        rightYAxis.setDrawScale(false);
        rightYAxis.setDrawZeroLine(false); // draw a zero line
...
//        leftYAxis.setZeroLineColor(Color.GRAY);
    ...
    public void setMarkerView(Context context) {
        ...
        final LineChartMarkView mv = new LineChartMarkView(context, xAxis.getValueFormatter());
        ...
        lineChart.setOnChartGestureListener(new OnChartGestureListener() {
            ...
            public void onChartGestureEnd(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
                ...
                lineChart.setDrawMarkers(false);//取消点击提示
//                lineChart.setHighlightPerDragEnabled(false);
                lineChart.highlightValue(null);//取消十字定位
